...
const Imag = ({ width }) => {
  ...
  return (
    ...
    <div className="flex-auto">
        ...
        <div className="flex ">
            <div className="flex-auto">
                <p className={styles.UbuntuWhite}>Muhammad Hanif</p>
                <p className={styles.UbuntuWhite}>Event Organizer Team Leader</p>
                <p className={styles.UbuntuWhite}>ID Line: mhanifnasution</p>
                <p className={styles.UbuntuWhite}>WA: 0878 8811 8859</p>
            </div>
            <div className="flex-auto">
                <p className={styles.UbuntuWhite}>Tugus Ibram</p>
                <p className={styles.UbuntuWhite}>Head of Watch This!</p>
                <p className={styles.UbuntuWhite}>ID Line: tugusavanindra</p>
                <p className={styles.UbuntuWhite}>WA: 0821 1989 9965</p>
            </div>
        </div>
