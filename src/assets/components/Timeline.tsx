    ...
    return (
        <div className={styles.body}>
            <div className="timelineMaster">
                ...
                <div className = {styles.timelineDiv}>
                    <p className={styles.timelineText} id={styles.timelineTextUp}>1 - 7<br/>Agustus&nbsp;2021</p>
                    <div className={!invertColors ? styles.timelineCircle : styles.circleInverted} />
                    <p className={styles.timelineText} id={styles.timelineTextDown}>Extended Regist <br/>Phase</p>
                </div>
                <div className = {styles.timelineDiv}>
                    <p className={styles.timelineText} id={styles.timelineTextUp}>1 - 13<br/>August&nbsp;2021</p>
                    <div className={!invertColors ? styles.timelineCircle : styles.circleInverted}/>
                    <p className={styles.timelineText} id={styles.timelineTextDown}>Preliminary<br/>Round</p>
                </div>
                <div className = {styles.timelineDiv}>
                    <p className={styles.timelineText} id={styles.timelineTextUp}>8 - 13<br/>August&nbsp;2021</p>
                    <div className={!invertColors ? styles.timelineCircle : styles.circleInverted} />
