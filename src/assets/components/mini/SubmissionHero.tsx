...
import styles from '../../../styles/MiniHero.module.scss';
...
const HomeHero = () => {
    ...
    return (
        <div className={styles.container+" pt-20 pb-20 bg-cover bg-no-repeat bg-center flex flex-col md:flex-row justify-center w-full"}  id="home">
            ...
            <div>
            <span className={styles.biggestEvent+" "}>Mini Challenge. <br/>Big Prize.</span><br/>
                <span className={styles.bePart}>Join now!</span>               
            </div>
            ...
            <div className="flex-NONE md:pr-32 self-center md:justify-end">
                <Countdown deadline="September 2 2021 23:59:59"/>
            </div>
        </div>
    )
}
