  ...
  return (
    ...
    <div className="flex-auto">
        ...
        <div className="flex ">
            ...
            <div className="flex-auto">
                <p className={styles.UbuntuWhite}>Vania Alya</p>
                <p className={styles.UbuntuWhite}>Webinar Team Leader</p>
                <p className={styles.UbuntuWhite}>ID Line: vaniaalya</p>
                <p className={styles.UbuntuWhite}>WA: 0851 5651 4184</p>
            </div>
        </div>
